...
public class FiguresObjects {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        canvas.addFigure(new Circle(new Point(110, 120), 50, new Distance(1, 2), Color.RED));
        canvas.addFigure(new Circle(new Point(90, 60), 30, new Distance(2, 2), Color.YELLOW));
        canvas.addFigure(new Square(new Point(50, 50), 40, new Distance(2, 3), Color.GREEN));
        canvas.addFigure(new Square(new Point(200, 150), 50, new Distance(1, 1), Color.GRAY));
        canvas.addFigure(new Triangle(new Point(40, 30), new Point(55, 80), new Point(90, 70),
                new Distance(3, 2), Color.BLUE));
        canvas.addFigure(new Triangle(new Point(200, 250), new Point(240, 180), new Point(270, 220),
                new Distance(2, 1), Color.MAGENTA));
